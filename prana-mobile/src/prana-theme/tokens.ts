...
export const docIconGradients = {
  ...
  letter: { colors: ['#8B5CF6', '#A78BFA'] as const, start: { x: 0, y: 0 }, end: { x: 1, y: 1 } },
  tax:    { colors: ['#10B981', '#34D399'] as const, start: { x: 0, y: 0 }, end: { x: 1, y: 1 } },
  bank:   { colors: ['#3B82F6', '#60A5FA'] as const, start: { x: 0, y: 0 }, end: { x: 1, y: 1 } },
} as const;
