...
class SuccessCode(StrEnum):
    ...
    SEVERITY_RULE_CREATED  = "SEVERITY_RULE_CREATED"
    SEVERITY_RULE_UPDATED  = "SEVERITY_RULE_UPDATED"
    COMM_CHANNEL_POLICY_UPDATED = "COMM_CHANNEL_POLICY_UPDATED"
    COMM_VENDOR_CHAIN_UPDATED   = "COMM_VENDOR_CHAIN_UPDATED"
    COMM_VENDOR_CREDENTIAL_ROTATED = "COMM_VENDOR_CREDENTIAL_ROTATED"
    PLATFORM_CREDENTIAL_ROTATED    = "PLATFORM_CREDENTIAL_ROTATED"
    HMAC_ROTATION_APPROVAL_SIGNALED = "HMAC_ROTATION_APPROVAL_SIGNALED"
    ...
    EMPLOYEE_TOTP_RESET    = "EMPLOYEE_TOTP_RESET"
    EMPLOYEE_PASSWORD_RESET = "EMPLOYEE_PASSWORD_RESET"
    EMPLOYEE_REACTIVATED   = "EMPLOYEE_REACTIVATED"
    EMPLOYEE_SESSIONS_REVOKED = "EMPLOYEE_SESSIONS_REVOKED"
    EMPLOYEE_SHARES_REVOKED  = "EMPLOYEE_SHARES_REVOKED"
    EMPLOYEE_BULK_IMPORT_COMPLETE = "EMPLOYEE_BULK_IMPORT_COMPLETE"
    EMPLOYEE_RECORDS_MERGED = "EMPLOYEE_RECORDS_MERGED"
    OA_WELCOME_EMAIL_RESENT = "OA_WELCOME_EMAIL_RESENT"
