...
from tests.test_doc_manifest import (
    ...
    test_manifest_record_score_with_weights_prioritizes_higher_weight_signal,
    test_manifest_record_score_no_weights_falls_back_to_equal,
    test_manifest_record_score_mismatched_weight_length_falls_back_to_equal,
    ...
    test_auto_detect_tie_breaks_on_usage_count,
    test_auto_detect_query_has_defensive_limit,
    test_record_usage_increments_tenant_override_when_present,
    test_record_usage_falls_back_to_platform_default,
