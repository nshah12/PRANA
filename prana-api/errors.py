...
class PranaError(StrEnum):
    ...
    IDENTIFIER_REQUIRED       = "IDENTIFIER_REQUIRED"     # reset-TOTP lookup: neither email nor mobile given
    ...
    REASON_NOTE_REQUIRED_FOR_OTHER = "REASON_NOTE_REQUIRED_FOR_OTHER"
    ...
    EMPLOYEE_NOT_ALUMNI       = "EMPLOYEE_NOT_ALUMNI"   # reactivate: employee is not currently marked as alumni
    ...
    CSV_INVALID_DATE_FORMAT      = "CSV_INVALID_DATE_FORMAT"
    EMPLOYEE_CREATE_FAILED    = "EMPLOYEE_CREATE_FAILED"
    CANNOT_MERGE_SAME_EMPLOYEE = "CANNOT_MERGE_SAME_EMPLOYEE"
    ...
    SETUP_CHECKLIST_INCOMPLETE = "SETUP_CHECKLIST_INCOMPLETE"
    CHECKLIST_ITEM_NOT_FOUND   = "CHECKLIST_ITEM_NOT_FOUND"
    CHECKLIST_ITEM_KEY_TAKEN   = "CHECKLIST_ITEM_KEY_TAKEN"
    CANNOT_EDIT_PLATFORM_ITEM  = "CANNOT_EDIT_PLATFORM_ITEM"
