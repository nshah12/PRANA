...
Extract ONLY the fields listed below from the provided increment / salary revision letter.
...
def build_user_prompt(redacted_text: str) -> str:
    return f"""DOCUMENT TYPE: Increment / Salary Revision Letter
DOCUMENT TEXT:
{redacted_text}
...
designation          — Current job title (post-revision)
